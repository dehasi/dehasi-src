...
If you have separate Jenkins CIs on separate repos, you can set up upstream build.
It means that if one of the project dependencies changes, the project CI job will be triggered.
